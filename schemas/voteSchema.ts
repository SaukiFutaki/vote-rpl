...
export const candidateSchema = z.object({
    ...
    vision: z.string().min(0, "Visi minimal 0 karakter").max(500, "Visi maksimal 500 karakter"),
    mission: z.string().min(0, "Misi minimal 0 karakter").max(1000, "Misi maksimal 1000 karakter"),
 ...
 export const formVoteSchema = z.object({
    ...
    dateRange: z.object({
      ...
      isViewabled : z.boolean().default(false),
