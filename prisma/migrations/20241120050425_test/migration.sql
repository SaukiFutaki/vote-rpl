...
-- CreateIndex
CREATE UNIQUE INDEX "voting_sessions_code_key" ON "voting_sessions"("code");
...
-- AddForeignKey
ALTER TABLE "candidates" ADD CONSTRAINT "candidates_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "voting_sessions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
